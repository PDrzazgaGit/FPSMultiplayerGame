...
namespace InfimaGames.LowPolyShooterPack
{
    public abstract class WeaponBehaviour : MonoBehaviour
    {
        ...
        /// <param name="onGround">Information if the player is jumping</param>
        public abstract void Fire(float spreadMultiplier = 1.0f, bool onGround = true, bool isMoving = false);
        /// <summary>
        /// Reloads the weapon.
        /// </summary>
