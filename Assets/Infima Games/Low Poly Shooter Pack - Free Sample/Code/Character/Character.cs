...
namespace InfimaGames.LowPolyShooterPack
{
	...
	public sealed class Character : CharacterBehaviour
	{
		...
		/// <summary>
		/// True if the player is holding the crouching button
		/// </summary>
        ...
        {
            Vector2 frameInput = GetInputMovement();
            return frameInput != Vector2.zero;
        }
        /// <summary>
		...
		private void Fire()
		{
			...
			if (crouching)
			{
                equippedWeapon.Fire(1.0f, Ground, false);
            }
			else
			{
                equippedWeapon.Fire(1.0f, Ground, IsMoving());
            }
